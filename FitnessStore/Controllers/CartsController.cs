...
namespace FitnessStore.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(FitnessStoreContext context)
        {
            _context = context; 
        }
        ...
        {
            var FitnessStoreContext = _context.Cart.Include(c => c.Account);
            return View(await FitnessStoreContext.ToListAsync());
        }
